...
Accel_data_in(1,:) = ((dlmread("m_moderate.txt")(:,1))')(1:BUFFER_SIZE);
Accel_data_in(2,:) = ((dlmread("m_moderate.txt")(:,2))')(1:BUFFER_SIZE);
Accel_data_in(3,:) = ((dlmread("m_moderate.txt")(:,3))')(1:BUFFER_SIZE);
